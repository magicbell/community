...
1. From the **Settings &rarr; Channels** page in your dashboard, select **Add Provider &rarr; Mobile Push &rarr; Firebase FCM **.
...
<img
  className="full-mobile"
  src="/docs/uploads/mobile-push-firebase-add.png"
  style={{ width: '100%', height: 'intrinsic' }}
/>
<img
  className="full-mobile"
  src="/docs/uploads/mobile-push-firebase-enable.png"
  style={{ width: '100%', height: 'intrinsic' }}
/>
