...
You might also find it helpful to read the [full React Native example](https://github.com/magicbell-io/public/tree/main/examples/react-native-notifications-example) we created.
