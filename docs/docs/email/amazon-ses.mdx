...
The `notification.overrides.amazon_ses` parameter accepts all the body parameters of [SES SendEmail API](https://docs.aws.amazon.com/ses/latest/APIReference/API_SendEmail.html).
