...
Nota bene, if you are using templates in your email provider (via [overrides](/docs/overrides#provider-overrides)), all the rendering happens there, and the we ignore the email layout.
