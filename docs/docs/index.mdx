...
<Note className="text-lg text-center">
  Browse discussions, updates, and get help in our <a href="https://github.com/orgs/magicbell-io/discussions" target="_blank" rel="noopener noreferrer">Github Community</a>
</Note>
...
answer as soon as humanly possible! Or [request a demo](https://magicbell.typeform.com/to/AgrVeIk5)
