---
title: API Overview
subtitle: The API spec, error codes, rate limits, and other must-know information.
---
...
- [Download the OpenAPI Spec](https://github.com/magicbell-io/public/blob/main/openapi/spec/openapi.json)
- [Use the Postman collection](https://www.postman.com/magicbell-api/workspace/magicbell/collection/2269098-9f990075-94a8-4ded-b252-a5289b6e3a2f)
