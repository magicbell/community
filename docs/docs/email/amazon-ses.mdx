...
The [create notifications endpoint](/docs/rest-api/reference#create-notification) allows you to customize the payload sent to SES by [adding a provider-specific override](/docs/overrides).

The `notification.overrides.providers.amazon_ses` parameter accepts all the body parameters of [SES SendEmail API](https://docs.aws.amazon.com/ses/latest/APIReference/API_SendEmail.html).
Please keep in the correct capitalization of the parameters.
